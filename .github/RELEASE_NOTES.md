...
## 🆕 New in v0.3.2 — real content editing
...
| Platform | File |
|----------|------|
| **Windows** (x64) | `PDF.Studio_0.3.2_x64-setup.exe` or `..._x64_en-US.msi` |
| **macOS** (Apple Silicon) | `PDF.Studio_0.3.2_aarch64.dmg` |
| **macOS** (Intel) | `PDF.Studio_0.3.2_x64.dmg` |
| **Linux** (Debian/Ubuntu) | `PDF.Studio_0.3.2_amd64.deb` |
| **Linux** (Fedora/RHEL) | `PDF.Studio-0.3.2-1.x86_64.rpm` |
| **Linux** (portable) | `PDF.Studio_0.3.2_amd64.AppImage` |
